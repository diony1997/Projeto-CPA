    ...
    <body>
        ...
        <header>
            ...
            <div class = "wrapper">
                ...
                <div class="insert">
                    <form action="loginUser_resp.php" method="post">
                        <h1>LOGIN ADMIN</h1>
                        <br/>
                        <input class="caixa" type="text" name="user" placeholder="Usuario" required/>
                        <br/><br/>
                    ...
                    if (isset($_SESSION['loginerror'])) {
                        if ($_SESSION['loginerror'] == 1) {
                            echo '<span style="color:#B22222;text-align:center;">Usuario inválido</span>';
                        } 
